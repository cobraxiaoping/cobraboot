...
public class QuartzJob implements Serializable {
	...
	public QuartzJob(String jobName, String jobGroup, String jobStatus, String isConcurrent, String cronExpression,
			String description, String springId, String jobClass, String methodName) {
		super();
		this.jobName = jobName;
		this.jobGroup = jobGroup;
